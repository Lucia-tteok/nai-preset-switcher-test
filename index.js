...
(function() {
    ...
    var EXT_NAME = "/nai-preset-test"; // 扩展文件夹名，服务端会补全为 third-party/<name>
    var PANEL_ID = "nai-lib-panel-v2";
    var BAR_ID = "nai-update-bar";
    var MODAL_ID = "nai-update-modal";
    var MANIFEST_URLS = [
        "https://raw.githubusercontent.com/Lucia-tteok/nai-preset-test/main/manifest.json",
        "https://cdn.jsdelivr.net/gh/Lucia-tteok/nai-preset-test@main/manifest.json"
    ];
...
!async function() {
    ...
    function B() {
        ...
        a(), n.addEventListener("click", () => {
            ...
            t.className = "nl-tagpicker", t.innerHTML = `<div class="nl-tagpicker-box"><div class="nl-tagpicker-title">选择预设标签</div><div id="nl-ptaglist">${n()}</div><div class="nl-tagpicker-foot"><button class="nl-btn ghost" id="nl-ptagadd" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">新建标签</button><button class="nl-btn ghost" id="nl-ptagcancel" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">取消</button><button class="nl-btn" id="nl-ptagok" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">确定</button></div></div>`;
    ...
    async function R() {
        ...
        }).join("") + "</div>" : '<div class="nl-empty">还没有收藏，去"导入预设"标签添加吧</div>', t.innerHTML = `\n<div style="margin-bottom:10px;"><div class="nl-chips" id="nl-filter">${j}</div>\n</div>\n<div style="display:flex;gap:8px;align-items:center;margin-bottom:10px;"><div class="nl-search-wrap"><input type="text" class="nl-search" id="nl-search-input" placeholder="搜索预设名称..." value="${k(u)}"></div><span class="nl-viewtoggle" id="nl-viewtoggle" title="${"grid"===v?"列表视图":"网格视图"}">${"grid"===v?"☰":"☷"}</span><span class="nl-viewtoggle" id="nl-randpick" title="随机抽取">⚄</span><span class="nl-viewtoggle" id="nl-multisel-btn" title="多选" style="${b?"background:var(--nl-accent);color:#fff;border-color:var(--nl-accent);":""}">${b?"✕":"☑"}</span>\n</div>\n${b?'<div class="nl-multibar" id="nl-multibar"><span style="font-size:13px;color:#566472;" id="nl-selcount">已选 0 项</span><button class="nl-btn ghost" id="nl-sel-all" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">全选</button><button class="nl-btn ghost" id="nl-sel-tag" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">改标签</button><button class="nl-btn ghost" id="nl-sel-auto" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">自动分类</button><button class="nl-btn danger" id="nl-sel-del" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">删除</button></div>':""}\n${q}`, t.querySelectorAll(".nl-chip[data-fcat]").forEach(e => {
        ...
        RB && RB.addEventListener('click', function() {
            ...
            function render() {
                ...
                sel = null;
                if (!picks.length) {
                    mask.innerHTML = '<div style="background:rgba(255,255,255,.82);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,.6);border-radius:18px;padding:26px;color:#2a3640;font-size:14px;text-align:center;box-shadow:0 18px 50px rgba(40,55,70,.28);">\u5f53\u524d\u5206\u7c7b\u6ca1\u6709\u53ef\u62bd\u53d6\u7684\u9884\u8bbe<div style="margin-top:16px;"><button class="nl-btn ghost" id="nl-rand-cancel" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">\u5173\u95ed</button></div></div>';
            ...
            function showBtns() {
                ...
                bar.innerHTML = '<button class="nl-btn ghost" id="nl-rand-cancel" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">\u53d6\u6d88</button><button class="nl-btn ghost" id="nl-rand-reroll" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">\u91cd\u65b0\u62bd\u53d6</button><button class="nl-btn" id="nl-rand-apply" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">\u8bbe\u4e3a\u9884\u8bbe</button>';
        ...
        if (D && D.addEventListener("click", () => {
            ...
            O && O.addEventListener("click", () => {
                ...
                function n(n) {
                    ...
                    a.innerHTML = `<div class="nl-tagpicker-box"><div class="nl-tagpicker-title">${o}</div><div id="nl-mtaglist">${i()}</div><div class="nl-tagpicker-foot"><button class="nl-btn ghost" id="nl-mtagadd" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">+ 新建</button><button class="nl-btn ghost" id="nl-mtagcancel" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">取消</button><button class="nl-btn" id="nl-mtagok" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">确定</button></div></div>`, e.querySelector(".nl-box").appendChild(a), a.addEventListener("click", e => {
                        e.target === a && a.remove();
                ...
                t.className = "nl-tagpicker", t.innerHTML = '<div class="nl-tagpicker-box"><div class="nl-tagpicker-title">选择标签操作方式</div><div style="display:flex;flex-direction:column;gap:10px;margin-top:12px;"><button class="nl-btn" id="nl-tagmode-replace" style="flex:1;font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">覆盖原有标签</button><button class="nl-btn ghost" id="nl-tagmode-append" style="flex:1;font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">新增标签</button><button class="nl-btn ghost" id="nl-tagmode-cancel" style="flex:1;margin-top:4px;font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">取消</button></div></div>', e.querySelector(".nl-box").appendChild(t), t.addEventListener("click", e => {
                    e.target === t && t.remove()
    ...
    async function Q(e) {
        ...
        l && l.addEventListener("click", () => function(e, t) {
            ...
            a.className = "nl-tagpicker", a.innerHTML = `<div class="nl-tagpicker-box"><div class="nl-tagpicker-title">选择预设标签</div><div id="nl-taglist">${i()}</div><div class="nl-tagpicker-foot"><button class="nl-btn ghost" id="nl-tagadd" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">新建标签</button><button class="nl-btn ghost" id="nl-tagcancel" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">取消</button><button class="nl-btn" id="nl-tagok" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">确定</button></div></div>`, s.getElementById(r).querySelector(".nl-box").appendChild(a), a.addEventListener("click", e => {
                e.target === a && a.remove();
                const t = e.target.closest(".nl-tagpicker-item");
                if (t) {
                    const e = t.getAttribute("data-cat");
    ...
    async function ne(e) {
        ...
        var n, r = e.thumbnail || "";
        if (!r && e.image) try {
            r = await (n = e.image, new Promise(function(e) {
                try {
                    var t = new Image;
                    t.onload = function() {
                        try {
                            var n = t.naturalWidth,
                                r = t.naturalHeight;
                            if (!n || !r) return e("");
                            var a = Math.min(1, 96 / Math.max(n, r));
                            n = Math.round(n * a), r = Math.round(r * a);
                            var i = s.createElement("canvas");
                            i.width = n, i.height = r, i.getContext("2d").drawImage(t, 0, 0, n, r), e(i.toDataURL("image/jpeg", .7))
                        } catch (t) {
                            e("")
                        }
                    }, t.onerror = function() {
                        e("")
                    }, t.src = "data:image/png;base64," + n
                } catch (t) {
                    e("")
                }
            }))
        ...
        try {
            if (e.image) {
                var l = "string" == typeof e.image && 0 === e.image.indexOf("data:") ? e.image : "data:image/png;base64," + e.image;
                o = _(), await A(o, l)
            }
        } catch (e) {
            o = null
    ...
    function le() {
        ...
        oe && n[oe] || (oe = a), i = t.length ? '<div class="nl-vibe-grid">' + t.map(function(e) {
            var t = e.thumb ? '<img class="nl-vibe-card-thumb" src="' + e.thumb + '">' : '<div class="nl-vibe-card-thumb empty">&#127912;</div>',
                n = k(e.presetName),
                r = k(e.vibeDataId || "");
            return '<div class="nl-vibe-card" data-preset="' + n + '" data-vid="' + r + '">' + t + '<div class="nl-vibe-card-name">' + k(e.name || "未命名") + '</div><div class="nl-vibe-card-acts"><span class="nl-vibe-add" data-vid="' + r + '" title="加入当前组">＋</span><span class="nl-vibe-rename" data-preset="' + n + '" title="重命名">✎</span><span class="nl-vibe-del" data-preset="' + n + '" title="删除">✕</span></div></div>'
        }).join("") + "</div>" : '<div class="nl-empty" style="padding:18px;">还没有 Vibe，点上方按钮导入 .naiv4vibe / .json 文件</div>';
        ...
        o = c.length ? c.map(function(e, n) {
            ...
            }).join("") : '<div class="nl-empty" style="padding:14px;">该组为空，去上方列表点「＋组」添加 Vibe（可叠加多个）</div>', e.innerHTML = '<div class="nl-vibe-topbar"><button class="nl-btn" id="nl-vibe-import-btn" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">导入 Vibe 文件</button><button class="nl-btn ghost" id="nl-vibe-importgroup-btn" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">导入组</button><input type="file" id="nl-vibe-file" accept=".naiv4vibe,.json,application/json" multiple style="display:none;"><input type="file" id="nl-vibe-groupfile" accept=".json,application/json" style="display:none;"></div><details class="nl-vibe-listfold"' + (_vlf ? ' open' : '') + '><summary class="nl-vibe-sec-title" style="cursor:pointer;">Vibe 列表</summary>' + i + '</details><div class="nl-vibe-sec-title" style="margin-top:18px;">Vibe 叠加组</div><div class="nl-vibe-grouprow"><select class="nl-input" id="nl-vibe-groupsel" style="flex:1;">' + l + '</select><button class="nl-btn ghost" id="nl-vibe-newgroup" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">新建组</button><button class="nl-btn ghost" id="nl-vibe-renamegroup" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">重命名</button><button class="nl-btn ghost" id="nl-vibe-delgroup" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">删组</button><button class="nl-btn ghost" id="nl-vibe-savegroup" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">保存</button></div><div class="nl-vibe-groupcur">' + (oe === a ? '<span style="color:#3a9a5a;">✓ 这是智绘姬当前生效组</span>' : '<button class="nl-btn" id="nl-vibe-applygroup" style="font-size:15px!important;padding:13px!important;min-height:44px!important;line-height:1.2!important;box-sizing:border-box!important;">设为智绘姬当前组</button>') + '</div><div class="nl-vibe-slots">' + o + "</div>",
            function(e) {
                var _lf = e.querySelector(".nl-vibe-listfold");
                _lf && _lf.addEventListener("toggle", function() {
                    _vlf = _lf.open
                });
                var t = e.querySelector("#nl-vibe-import-btn"),
                    n = e.querySelector("#nl-vibe-file");
                t && n && (t.addEventListener("click", function() {
                    n.click()
                }), n.addEventListener("change", async function(e) {
                    var t = Array.from(e.target.files || []);
                    if (t.length) {
                        for (var r = 0, a = 0, i = 0; i < t.length; i++) try {
                            var o = await t[i].text(),
                                l = JSON.parse(o);
                            if (!te(l)) {
                                a++;
                                continue
                        ...
                        n.value = "", r ? E("已导入 " + r + " 个 Vibe" + (a ? "，" + a + " 个无效" : ""), "success") : E("没有有效的 Vibe 文件", "error"), le()
                    }
                }));
                var r = e.querySelector("#nl-vibe-importgroup-btn"),
                    a = e.querySelector("#nl-vibe-groupfile");
                r && a && (r.addEventListener("click", function() {
                    a.click()
                }), a.addEventListener("change", async function(e) {
                    var t = (e.target.files || [])[0];
                    if (a.value = "", t) {
                        try {
                            var n = JSON.parse(await t.text()),
                                r = await async function(e) {
                                    ...
                                    for (var r = {}, a = e.vibeData || {}, i = Object.keys(a), o = 0; o < i.length; o++) {
                                        var l = i[o],
                                            s = a[l];
                                        if (te(s)) try {
                                            var c, d = await ee(s);
                                    ...
                                    Object.keys(m).forEach(function(e) {
                                        ...
                                        if (a && Array.isArray(a.vibes)) {
                                            for (var i = e, o = 2; Object.prototype.hasOwnProperty.call(n.vibeGroups, i);) i = e + " (" + o + ")", o++;
                                            var l = [];
                            ...
                            r.groups && i.push(r.groups + " 个组"), r.presets && i.push(r.presets + " 个预设"), r.vibes && i.push(r.vibes + " 个 Vibe"), i.length ? E("已导入 " + i.join("、") + (r.errors && r.errors.length ? "，" + r.errors.length + " 项出错" : ""), "success") : E("未导入任何内容" + (r.errors && r.errors.length ? "：" + r.errors[0] : ""), "error")
                        } catch (e) {
                            E("导入组失败：" + (e && e.message ? e.message : "文件无效"), "error")
                        }
                        le()
                    }
                }));
                ...
                }), e.querySelectorAll(".nl-vibe-rename").forEach(function(e) {
                    e.addEventListener("click", function() {
                        var t = e.getAttribute("data-preset");
                        if ("默认" !== t) {
                            var n = prompt("新的预设名：", t);
                            null != n && ((n = n.trim()) ? n !== t && (! function(e, t) {
                                var n = W();
                                return !(!(n && n.vibePresets && n.vibePresets[e]) || !(t = (t || "").trim()) || t === e || Object.prototype.hasOwnProperty.call(n.vibePresets, t) || (n.vibePresets[t] = n.vibePresets[e], delete n.vibePresets[e], n.vibePresetId === e && (n.vibePresetId = t), X(), 0))
                            }(t, n) ? E("重命名失败（可能重名）", "error") : (E("已重命名", "success"), le())) : E("名称不能为空", "error"))
                        } else E("默认预设不可重命名", "warning")
                    })
                });
                ...
                l && l.addEventListener("click", function() {
                    if ("默认组" !== oe) {
                        ...
                        }(oe, e) ? E("重命名失败（可能重名）", "error") : (oe = e, E("已重命名组", "success"), le())) : E("组名不能为空", "error"))
                    ...
                    if ("默认组" !== oe) {
                        if (confirm("删除组「" + oe + "」？组内 Vibe 本身不会被删。")) {
                            var e = W(),
                                t = re(),
                                n = oe;
                            delete t[n], e.vibeGroupId === n && (e.vibeGroupId = "默认组"), X(), ae(n, ""), oe = "默认组", E("已删除组", "success"), le()
                        }
                    } else E("默认组不可删除", "warning")
                });
                var c = e.querySelector("#nl-vibe-applygroup");
                c && c.addEventListener("click", function() {
                    ie(oe) ? (E("已设为智绘姬当前组「" + oe + "」", "success"), le()) : E("切换失败", "error")
                });
