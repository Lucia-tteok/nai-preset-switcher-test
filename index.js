...
!async function() {
    ...
    function le() {
        ...
        o = c.length ? c.map(function(e, n) {
            ...
            }).join("") : '<div class="nl-empty" style="padding:14px;">该组为空，去上方列表点「＋组」添加 Vibe（可叠加多个）</div>', e.innerHTML = '<div class="nl-vibe-topbar"><button class="nl-btn" id="nl-vibe-import-btn" style="font-size:12px!important;padding:6px 7px!important;min-height:30px!important;line-height:1.1!important;box-sizing:border-box!important;">导入 Vibe 文件</button><button class="nl-btn ghost" id="nl-vibe-importgroup-btn" style="font-size:12px!important;padding:6px 7px!important;min-height:30px!important;line-height:1.1!important;box-sizing:border-box!important;">导入组</button><input type="file" id="nl-vibe-file" accept=".naiv4vibe,.json,application/json" multiple style="display:none;"><input type="file" id="nl-vibe-groupfile" accept=".json,application/json" style="display:none;"></div><details class="nl-vibe-listfold"' + (_vlf ? ' open' : '') + '><summary class="nl-vibe-sec-title" style="cursor:pointer;">Vibe 列表</summary>' + i + '</details><div class="nl-vibe-sec-title" style="margin-top:18px;">Vibe 叠加组</div><div class="nl-vibe-grouprow"><select class="nl-input" id="nl-vibe-groupsel" style="flex:1;">' + l + '</select><button class="nl-btn ghost" id="nl-vibe-newgroup" style="font-size:12px!important;padding:6px 7px!important;min-height:30px!important;line-height:1.1!important;box-sizing:border-box!important;">新建组</button><button class="nl-btn ghost" id="nl-vibe-renamegroup" style="font-size:12px!important;padding:6px 7px!important;min-height:30px!important;line-height:1.1!important;box-sizing:border-box!important;">重命名</button><button class="nl-btn ghost" id="nl-vibe-delgroup" style="font-size:12px!important;padding:6px 7px!important;min-height:30px!important;line-height:1.1!important;box-sizing:border-box!important;">删组</button><button class="nl-btn ghost" id="nl-vibe-savegroup" style="font-size:12px!important;padding:6px 7px!important;min-height:30px!important;line-height:1.1!important;box-sizing:border-box!important;">保存</button></div><div class="nl-vibe-groupcur">' + (oe === a ? '<span style="color:#3a9a5a;">✓ 这是智绘姬当前生效组</span>' : '<button class="nl-btn" id="nl-vibe-applygroup" style="font-size:12px!important;padding:6px 7px!important;min-height:30px!important;line-height:1.1!important;box-sizing:border-box!important;">设为智绘姬当前组</button>') + '</div><div class="nl-vibe-slots">' + o + "</div>",
            function(e) {
