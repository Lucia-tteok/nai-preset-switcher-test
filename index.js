...
!async function() {
    ...
    function B() {
        ...
        a(), n.addEventListener("click", () => {
            ...
            t.className = "nl-tagpicker", t.innerHTML = `<div class="nl-tagpicker-box"><div class="nl-tagpicker-title">选择预设标签</div><div id="nl-ptaglist">${n()}</div><div class="nl-tagpicker-foot"><button class="nl-btn ghost" id="nl-ptagadd" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">新建标签</button><button class="nl-btn ghost" id="nl-ptagcancel" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">取消</button><button class="nl-btn" id="nl-ptagok" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">确定</button></div></div>`;
    ...
    async function R() {
        ...
        }).join("") + "</div>" : '<div class="nl-empty">还没有收藏，去"导入预设"标签添加吧</div>', t.innerHTML = `\n<div style="margin-bottom:10px;"><div class="nl-chips" id="nl-filter">${j}</div>\n</div>\n<div style="display:flex;gap:8px;align-items:center;margin-bottom:10px;"><div class="nl-search-wrap"><input type="text" class="nl-search" id="nl-search-input" placeholder="搜索预设名称..." value="${k(u)}"></div><span class="nl-viewtoggle" id="nl-viewtoggle" title="${"grid"===v?"列表视图":"网格视图"}">${"grid"===v?"☰":"☷"}</span><span class="nl-viewtoggle" id="nl-randpick" title="随机抽取">⚄</span><span class="nl-viewtoggle" id="nl-multisel-btn" title="多选" style="${b?"background:var(--nl-accent);color:#fff;border-color:var(--nl-accent);":""}">${b?"✕":"☑"}</span>\n</div>\n${b?'<div class="nl-multibar" id="nl-multibar"><span style="font-size:13px;color:#566472;" id="nl-selcount">已选 0 项</span><button class="nl-btn ghost" id="nl-sel-all" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">全选</button><button class="nl-btn ghost" id="nl-sel-tag" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">改标签</button><button class="nl-btn ghost" id="nl-sel-auto" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">自动分类</button><button class="nl-btn danger" id="nl-sel-del" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">删除</button></div>':""}\n${q}`, t.querySelectorAll(".nl-chip[data-fcat]").forEach(e => {
        ...
        RB && RB.addEventListener('click', function() {
            ...
            function render() {
                ...
                sel = null;
                if (!picks.length) {
                    mask.innerHTML = '<div style="background:rgba(255,255,255,.82);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,.6);border-radius:18px;padding:26px;color:#2a3640;font-size:14px;text-align:center;box-shadow:0 18px 50px rgba(40,55,70,.28);">\u5f53\u524d\u5206\u7c7b\u6ca1\u6709\u53ef\u62bd\u53d6\u7684\u9884\u8bbe<div style="margin-top:16px;"><button class="nl-btn ghost" id="nl-rand-cancel" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">\u5173\u95ed</button></div></div>';
            ...
            function showBtns() {
                ...
                bar.innerHTML = '<button class="nl-btn ghost" id="nl-rand-cancel" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">\u53d6\u6d88</button><button class="nl-btn ghost" id="nl-rand-reroll" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">\u91cd\u65b0\u62bd\u53d6</button><button class="nl-btn" id="nl-rand-apply" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">\u8bbe\u4e3a\u9884\u8bbe</button>';
        ...
        if (D && D.addEventListener("click", () => {
            ...
            O && O.addEventListener("click", () => {
                ...
                function n(n) {
                    ...
                    a.innerHTML = `<div class="nl-tagpicker-box"><div class="nl-tagpicker-title">${o}</div><div id="nl-mtaglist">${i()}</div><div class="nl-tagpicker-foot"><button class="nl-btn ghost" id="nl-mtagadd" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">+ 新建</button><button class="nl-btn ghost" id="nl-mtagcancel" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">取消</button><button class="nl-btn" id="nl-mtagok" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">确定</button></div></div>`, e.querySelector(".nl-box").appendChild(a), a.addEventListener("click", e => {
                        e.target === a && a.remove();
                ...
                t.className = "nl-tagpicker", t.innerHTML = '<div class="nl-tagpicker-box"><div class="nl-tagpicker-title">选择标签操作方式</div><div style="display:flex;flex-direction:column;gap:10px;margin-top:12px;"><button class="nl-btn" id="nl-tagmode-replace" style="flex:1;font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">覆盖原有标签</button><button class="nl-btn ghost" id="nl-tagmode-append" style="flex:1;font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">新增标签</button><button class="nl-btn ghost" id="nl-tagmode-cancel" style="flex:1;margin-top:4px;font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">取消</button></div></div>', e.querySelector(".nl-box").appendChild(t), t.addEventListener("click", e => {
                    e.target === t && t.remove()
    ...
    async function Q(e) {
        ...
        l && l.addEventListener("click", () => function(e, t) {
            ...
            a.className = "nl-tagpicker", a.innerHTML = `<div class="nl-tagpicker-box"><div class="nl-tagpicker-title">选择预设标签</div><div id="nl-taglist">${i()}</div><div class="nl-tagpicker-foot"><button class="nl-btn ghost" id="nl-tagadd" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">新建标签</button><button class="nl-btn ghost" id="nl-tagcancel" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">取消</button><button class="nl-btn" id="nl-tagok" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">确定</button></div></div>`, s.getElementById(r).querySelector(".nl-box").appendChild(a), a.addEventListener("click", e => {
                e.target === a && a.remove();
                const t = e.target.closest(".nl-tagpicker-item");
                if (t) {
                    const e = t.getAttribute("data-cat");
    ...
    function le() {
        ...
        o = c.length ? c.map(function(e, n) {
            ...
            }).join("") : '<div class="nl-empty" style="padding:14px;">该组为空，去上方列表点「＋组」添加 Vibe（可叠加多个）</div>', e.innerHTML = '<div class="nl-vibe-topbar"><button class="nl-btn" id="nl-vibe-import-btn" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">导入 Vibe 文件</button><button class="nl-btn ghost" id="nl-vibe-importgroup-btn" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">导入组</button><input type="file" id="nl-vibe-file" accept=".naiv4vibe,.json,application/json" multiple style="display:none;"><input type="file" id="nl-vibe-groupfile" accept=".json,application/json" style="display:none;"></div><details class="nl-vibe-listfold"' + (_vlf ? ' open' : '') + '><summary class="nl-vibe-sec-title" style="cursor:pointer;">Vibe 列表</summary>' + i + '</details><div class="nl-vibe-sec-title" style="margin-top:18px;">Vibe 叠加组</div><div class="nl-vibe-grouprow"><select class="nl-input" id="nl-vibe-groupsel" style="flex:1;">' + l + '</select><button class="nl-btn ghost" id="nl-vibe-newgroup" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">新建组</button><button class="nl-btn ghost" id="nl-vibe-renamegroup" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">重命名</button><button class="nl-btn ghost" id="nl-vibe-delgroup" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">删组</button><button class="nl-btn ghost" id="nl-vibe-savegroup" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">保存</button></div><div class="nl-vibe-groupcur">' + (oe === a ? '<span style="color:#3a9a5a;">✓ 这是智绘姬当前生效组</span>' : '<button class="nl-btn" id="nl-vibe-applygroup" style="font-size:13px!important;padding:8px 10px!important;min-height:34px!important;line-height:1.15!important;box-sizing:border-box!important;">设为智绘姬当前组</button>') + '</div><div class="nl-vibe-slots">' + o + "</div>",
            function(e) {
