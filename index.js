...
!async function() {
    ...
    function nlPositionFloatingBall(e, t, n) {
        var r = 58, a = Math.max(8, (window.innerWidth || s.documentElement.clientWidth || 360) - r - 8), i = Math.max(8, (window.innerHeight || s.documentElement.clientHeight || 640) - r - 8);
    ...
    async function nlRefreshFloatingBall() {
        ...
        if (!e) {
            e = s.createElement("div"), e.id = "nl-floating-ball-v2", e.setAttribute("style", "position:fixed;width:58px;height:58px;border-radius:50%;z-index:100002;overflow:hidden;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,.92);border:1px solid rgba(124,108,255,.55);box-shadow:0 10px 28px rgba(40,55,70,.30);cursor:pointer;touch-action:none;user-select:none;-webkit-user-select:none;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);"), s.body.appendChild(e);
            var t = _getNaiSettings(), n = t && t.floatingBallPos;
            n && "number" == typeof n.left && "number" == typeof n.top ? nlPositionFloatingBall(e, n.left, n.top) : nlPositionFloatingBall(e, (window.innerWidth || 360) - 76, (window.innerHeight || 640) - 150);
        ...
        e.innerHTML = a && a.thumb ? '<img src="' + a.thumb + '" style="width:100%;height:100%;object-fit:cover;display:block;pointer-events:none;">' : '<div style="font-size:20px;color:#8a97a4;line-height:1;pointer-events:none;font-weight:700;">NAI</div>'
    }
