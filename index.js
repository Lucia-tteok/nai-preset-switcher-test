...
!async function() {
    ...
    function le() {
        ...
        o = c.length ? c.map(function(e, n) {
            ...
            }).join("") : '<div class="nl-empty" style="padding:14px;">该组为空，去上方列表点「＋组」添加 Vibe（可叠加多个）</div>', e.innerHTML = '<details class="nl-vibe-listfold"' + (_vlf ? ' open' : '') + '><summary class="nl-vibe-sec-title" style="cursor:pointer;">Vibe 列表</summary>' + i + '</details><div class="nl-vibe-sec-title" style="margin-top:18px;">Vibe 叠加组</div><div class="nl-vibe-grouprow"><select class="nl-input" id="nl-vibe-groupsel" style="flex:1;">' + l + '</select><button class="nl-btn ghost nl-vibe-groupbtn" id="nl-vibe-newgroup">新建组</button><button class="nl-btn ghost nl-vibe-groupbtn" id="nl-vibe-delgroup">删组</button><button class="nl-btn ghost nl-vibe-groupbtn" id="nl-vibe-savegroup">保存</button></div><div class="nl-vibe-groupcur">' + (oe === a ? '<span style="color:#3a9a5a;">✓ 这是智绘姬当前生效组</span>' : '<button class="nl-btn nl-vibe-groupbtn" id="nl-vibe-applygroup">设为智绘姬当前组</button>') + '</div><div class="nl-vibe-slots">' + o + "</div>",
            function(e) {
